          ...
          <Row>
            <Col className="p-1" lg={12} md={12} sm={12} xs={12}>
              <Card>
                <Card.Body>
                  <Row>
                    <Col md={3} lg={3} sm={6} xs={6} className="align-items-center justify-content-center d-flex">
                      <img className="cart-product-image" src={Product1} />
                    </Col>

                    <Col md={6} lg={6} sm={6} xs={6}>
                      <h5 className="product-name fw-bold">
                    ...
                    <Col md={3} lg={3} sm={12} xs={12} className="mt-3">
                      <input
                        placeholder="2"
              ...
              <Card>
                <Card.Body>
                  <Row>
                    ...
                    <Col md={4} lg={4} sm={6} xs={6} className="">
