          ...
          <Row>
            <Col key={1} xl={2} lg={2} md={2} sm={4} xs={6} className="p-1">
              <Card className="image-box card ">
                  <img src="https://rukminim1.flixcart.com/image/832/832/kg8avm80/mobile/n/p/d/apple-iphone-12-mini-dummyapplefsn-original-imafwgbfwyzztfnh.jpeg?q=70" alt="" className="center" />
                <Card.Body>
